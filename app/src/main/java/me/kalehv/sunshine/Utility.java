...
public class Utility {
    ...
    public static String formatTemperature(Context context, double temperature) {
        ...
        return String.format(context.getString(R.string.format_temperature_degrees), temperature);
    }
    ...
    /**
     * Converts wind speed into a readable string with direction suffix
     * @param context Context to use for resource localization
     * @param windSpeed Wind speed
     * @param degrees Wind direction degrees
     * @return String with wind speed in appropriate units and direction
     */
